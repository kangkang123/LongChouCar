...
*
 */
public class CompensationFeeAdapter extends BaseAdapter{

	private Context context;
	private List<CompensationFee> list;
	private int object;
	
	public CompensationFeeAdapter(Context context,List<CompensationFee> list) {
	...
	@Override
	public CompensationFee getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CompensationFee item = list.get(position);
		holder.mText1.setText(item.qy);
		holder.mText2.setText(item.xsz);
		holder.mText3.setText(item.cz);
		holder.mText4.setText(item.pz);
