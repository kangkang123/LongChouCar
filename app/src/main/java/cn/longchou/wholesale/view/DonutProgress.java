...
public class DonutProgress extends View {
    ...
    private Paint unfinishedPaintOuter;
    ...
    private final int default_finished_color = Color.rgb(3, 168, 254);
    private final int default_unfinished_color = Color.rgb(236, 248, 254);
    ...
    protected void initPainters() {
        ...
        unfinishedPaintOuter = new Paint();
        unfinishedPaintOuter.setColor(Color.rgb(182, 235, 255));
        unfinishedPaintOuter.setStyle(Paint.Style.STROKE);
        unfinishedPaintOuter.setAntiAlias(true);
        unfinishedPaintOuter.setStrokeWidth(1);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2.00f, getHeight() / 2.00f, innerCircleRadius, innerCirclePaint);
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText("", (getWidth() - textPaint.measureText(text)) / 2.00f, (getWidth() - textHeight) / 2.00f, textPaint);
        }

        if (!TextUtils.isEmpty(getInnerBottomText())) {
            innerBottomTextPaint.setTextSize(innerBottomTextSize);
            float bottomTextBaseline = getHeight() - innerBottomTextHeight - (textPaint.descent() + textPaint.ascent()) / 2;
            canvas.drawText(getInnerBottomText(), (getWidth() - innerBottomTextPaint.measureText(getInnerBottomText())) / 2.00f, bottomTextBaseline, innerBottomTextPaint);
        }
